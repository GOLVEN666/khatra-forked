...
<div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border  shadow-md">
  <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl justify-center" href="#">
    <img className="object-contain" src={props.image} loading="lazy" alt="image du produit" />
    {props.discount && (
    ...
    <div className="relative mx-auto w-full max-w-[550px] bg-white p-4">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="rounded-md bg-[#6F4E37] px-6 py-2.5 text-sm font-medium text-white hover:bg-[#3C2F2F] focus:outline-none focus:ring-4 focus:ring-[#A56D3C]"
          >
            Submit
          </button>
        </div>
  ...
  {showSuccessMessage && (
    <div className="fixed top-4 right-4 bg-green-500 text-white p-4 rounded shadow-md z-50">
