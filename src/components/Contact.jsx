                    ...
                    <div className="mb-4">
                        <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            ...
                            <p className="mx-auto mt-4 max-w-3xl text-xl text-brown-600 dark:text-brown-400">
                                Nous sommes là pour répondre à toutes vos questions ou commentaires. Contactez-nous et faisons de votre expérience café encore meilleure !
                            </p>
                        </div>
                    </div>
                    <div className="flex items-stretch justify-center">
                        <div className="grid md:grid-cols-2">
                                ...
                                <ul className="mb-6 md:mb-0">
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            <h3 className="mb-2 text-lg font-medium leading-6 text-brown-900 dark:text-white">Notre Adresse</h3>
                                    ...
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            <h3 className="mb-2 text-lg font-medium leading-6 text-brown-900 dark:text-white">Contact</h3>
                                    ...
                                    <li className="flex">
                                        ...
                                        <div className="ml-4 mb-4">
                                            <h3 className="mb-2 text-lg font-medium leading-6 text-brown-900 dark:text-white">Horaires d'Ouverture</h3>
                                            <p className="text-brown-600 dark:text-brown-400">Lundi - Vendredi: 08:00 - 17:00</p>
                                            <p className="text-brown-600 dark:text-brown-400">Samedi &amp; Dimanche: 08:00 - 12:00</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                                ...
                                <form id="contactForm" onSubmit={handleSubmit}>
                                    <div className="mb-6">
                                        ...
                                        <input
                                            ...
                                            className="mb-2 w-full rounded-md border border-brown-400 py-2 pl-2 pr-4 shadow-md dark:text-brown-300 sm:mb-0"
                                        />
                                        </div>
                                        <div className="mx-0 mb-1 sm:mb-4">
                                ...
                                {showSuccessMessage && (
                                <p className="mt-4 text-green-500">Votre message a été envoyé avec succès !</p>
                                )}
                            </div>
                        </div>
                    </div>
